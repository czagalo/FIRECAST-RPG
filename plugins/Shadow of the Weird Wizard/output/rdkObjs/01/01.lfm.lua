...
local function constructNew_frmF01()
    ...
    obj:setDataType("br.com.czagalo_Weird_Wizard_01");
...
local _frmF01 = {
    ...
    new = newfrmF01, 
    name = "frmF01", 
    dataType = "br.com.czagalo_Weird_Wizard_01", 
...
frmF01 = _frmF01;
Firecast.registrarForm(_frmF01);
Firecast.registrarDataType(_frmF01);
